...
public class CompanyManager extends Company {
	public void update(Customer[] customers,CustomerManager customerManager) {
		...
		String result=scanner.nextLine();//kullanýcýnýn gireceði seçenekler
	...
	public void control(Customer[] customers) {//kullanýcý kontrol
	...
	public void sold(Customer customers,int howManySold) {
		System.out.println(customers.getFirstName()+" için "+howManySold+" adet satýþ yapýldý. kapmanya sonrasý kazanç:"+
				( howManySold*2)+"\n");
